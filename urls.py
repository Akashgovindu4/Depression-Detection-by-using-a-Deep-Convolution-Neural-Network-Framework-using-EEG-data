...
urlpatterns = [
    ...
    url(r'^Predict_Depression_Type/$', remoteuser.Predict_Depression_Type, name="Predict_Depression_Type"),
    ...
    url(r'^View_Depression_Type_Ratio/$', serviceprovider.View_Depression_Type_Ratio, name="View_Depression_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Depression_Type/$', serviceprovider.View_Prediction_Of_Depression_Type, name="View_Prediction_Of_Depression_Type"),
